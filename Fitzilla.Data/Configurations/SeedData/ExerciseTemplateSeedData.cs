    ...
    public static List<ExerciseTemplate> ExerciseTemplates()
    {
        ...
        [
            ...
            new ExerciseTemplate
            {
                ...
                Equipment = Equipment.Dumbbell,
                TargetMuscles = [TargetMuscle.Triceps],
                Description = "The on a free weights exercise that primarily targets the triceps and to a lesser degree also targets the chest and shoulders. The only one-arm overhead extension equipment that you really need is the following: dumbbell.",
            },
